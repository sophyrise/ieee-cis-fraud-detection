...
მონაცემთა დაყოფა აქაც წინასნაირად მოხდა (logistic_regression-ის პირველი ნაბიჯი)
...
Fold-ების AUC: [0.8461, 0.8460, 0.8435, 0.8578, 0.8473]
Mean CV AUC: 0.8481
...
Xამ პროექტში XGBoost ყველაზე ეფექტური მოდელი აღმოჩნდა. საწყის ეტაპზე მოდელი სტანდარტული პარამეტრებით და კლასის
...
![XGBoost Analysis](./Pictures/xgboost_training_analysis.png)
