...
## 🔁 კროს-ვალიდაცია (5-Fold, 150k სემპლი)
...
გადახრით ვხვდებით, რომ
მოდელი ყველა დაყოფაზე კარგად მუშაობს. საბოლოო gap (0.0321) ოდნავ მაინც აღემატება მკაცრ 0.03 საზღვარს, თუმცა რაკი დატაზე
დისბალანსი მაქვს, ეს ოდნავი აცდენა დავიკიდე.
